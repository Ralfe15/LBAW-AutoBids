            ...
            <form method="POST" action="{{ route('create-auction') }}" id="createauction-form"
                ...
                <div class="vin-form">
                    ...
                    <input required type="text" class="form-control" name="vin" minlength="17" maxlength="17"
                           id="vin-form" placeholder="Ex: 2G1WC5E37D1135027">
                </div>
                <div class="mileage-form">
                    <label for="mileageForm" class="form-label">Mileage</label>
                    <input required type="number" class="form-control" name="mileage" min=0 id="mileage-form"
                           placeholder="Ex: 12727">
                </div>
                <div class="year-form">
                    <label for="yearForm" class="form-label">Year</label>
                    <input required type="number" class="form-control" name="year" min="1900" max="2099" id="year-form"
                           placeholder="Ex: 2012">
                </div>
                ...
                <div class="power-form">
                    ...
                    <input required type="number" min=0 class="form-control" name="power" id="power-form"
                           placeholder="Ex: 227">
                </div>
                <div class="displacement-form">
                    <label for="displacementForm" class="form-label">Displacement</label>
                    <input required type="number" min="1" class="form-control" name="displacement"
                           id="displacement-form" placeholder="Ex: 2000">
                </div>
                <div class="color-form">
                    <label for="colorForm" class="form-label">Color</label>
                    <input required type="text" class="form-control" name="color" id="color-form"
                           placeholder="Ex: Blue">
                </div>
                ...
                <div class="startingbid-form">
                    ...
                    <input type="number" min="1" class="form-control" name="starting_bid" id="startingbid-form"
